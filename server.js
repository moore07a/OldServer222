...
const {
  ...
  evictOldestMapEntry,
  boundedMapSet
} = require("./modules/runtime-utils/runtimeConfig.js");
...
const SCANNER_OPTIONAL_URL_PREFIX = String(process.env.OPTIONAL_URL_PREFIX || "")
  ...
  .join("/");
const createScannerProbeMatching = require("./modules/scanner-security/scannerProbeMatching.js");
const {
...
const createScannerBehaviorPolicy = require("./modules/scanner-security/scannerBehaviorPolicy.js");
const {
...
const createRuntimeServices = require("./modules/runtime-utils/runtimeServices.js");
const {
...
const createScannerProbeBlocker = require("./modules/scanner-security/scannerProbeBlocker.js");
...
// ================== HELPER FUNCTIONS ==================
const createRedirectPayload = require("./modules/redirect-payload/redirectPayload.js");
const {
  mask,
  safeZone,
  TIMEZONE,
...
const createScannerDetection = require("./modules/scanner-security/scannerDetection.js");
const {
  IMPERSONATE_SCANNER,
...
const createTurnstileSecurity = require("./modules/challenge/turnstileSecurity.js");
const {
  headlessSuspicion,
  TURNSTILE_SITEKEY,
  TURNSTILE_SECRET,
...
const createPublicUtilities = require("./modules/public-content/publicUtilities.js");
const {
  rotationSeed,
  hash32,
  deterministicPick,
...
const createPublicContent = require("./modules/public-content/publicContent.js");
const {
...
const createCoreRoutes = require("./modules/runtime-routes/coreRoutes.js");
({
...
const createProcessLifecycle = require("./modules/runtime-lifecycle/processLifecycle.js");
